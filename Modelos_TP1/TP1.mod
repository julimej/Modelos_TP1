 ...
 * OPL 12.10.0.0 Model
 * Author: julian
 * Creation Date: Feb 4, 2021 at 5:43:06 PM
 *********************************************/
{string} EMPLEADOS = ...;
...
int Njl[1..4];
int Njm[1..4]; //matrix de dia vs tarea para cada categoria
int Njx[1..4];
...
dvar boolean Yilm[1..20][1..3][1..4];
...
subject to {
  ...
  Yilm[1][2][t]
  Elrm == sum (e in E) (sum (d in D) (sum (t in T) Yilm[e][d][t]));
